...
#' @param sent_location Regex for detecting autogenerated messages for locations shared via chat.
#' @param live_location Regex for detecting autogenerated messages for live locations shared via chat.
...
parse_android <- function(chatlog,
  ...
  # As a quick fix, we can simply paste them back together. Ultimately,
