...
#' @param plot Type of plot to be returned, options include "bar" and "pie". edefault is "bar".
#' @import ggplot2
...
# TODO: Replace this with a similar function to the token plotting function
MsgDsp <- function(data,
                   names = "all",
