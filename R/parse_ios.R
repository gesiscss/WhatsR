#' @title Parsing raw WhatsApp Chat Textfiles according to iOs text structure
#'
#' @description Creates a data frame from an exported WhatsApp chatlog containing one row per message
